    ...
    return (
        <>
            <section className="steps-container">
                <div className="partners_ban partners_ban1">
                    <div className="container">
                        <div className="baner_p">
                ...
                <div className="container">
                    <h1 className="hd">OUR PARTNERS</h1>
                    <div className="main1">
                        <h3 className="hbg">partners</h3>
                        ...
                        <div className="partner-box bott">
                            <div className="partner-img">
                        ...
                        <div className="partner-box bott1">
                            <div className="partner-img">
                        ...
                        <div className="partner-box bott2">
                            <div className="partner-img">
                        ...
                        <div className="partner-box bott1" style={{ width: "43%" }}>
                            <div className="partner-img">
                        ...
                        <div className="partner-box bott" style={{ marginTop: "-5%" }}>
                            <div className="partner-img">
                        ...
                        <div className="partner-box bott1" style={{ width: "43%", marginTop: "1%" }}>
                            <div className="partner-img">
            ...
            <div className="become_p" id="contactus">
                <div className="container">
                    <div className="inner_partnere">
                        ...
                        <form onSubmit={fetchContactUs}>
                            ...
                            <div className="partner_f">
                                ...
                                <textarea rows="2" id='message' name='message' value={message} onChange={handleText} required></textarea>
                            </div>
                            <button type='submit'>
                                {
                                    !buttonLoading ? <span id="send_t">Submit</span> : <div className='spinner' id="loader1"> <span className='bounce1'></span><span className='bounce2'></span><span
