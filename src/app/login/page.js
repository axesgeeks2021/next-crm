...
function page() {
    ...
    const forgotPassword = () => {
        try {
            ...
            const formdata = new FormData();
            formdata.append("email_address", "kalimali2295@gmail.com");
            ...
            <div className="video_bg sign_up_1">
                <div className="container container-sm video_front">
                                        ...
                                        <div className="user-details" id="login_click">
                                            <form onSubmit={userLogin}>
                                                ...
                                                <div style={{ position: "relative" }}>
                                                    <input type={!showPassword ? "password" : "text"} name="password" onChange={handleChange} placeholder="Password" required id="id_password" />
                                                    {
                                                        showPassword ? <i onClick={() => setShowPassword(false)} className="fa fa-eye " aria-hidden="true" id="togglePassword" style={{
                                                            top: "31%", marginLeft: "-30px",
                                                            cursor: "pointer",
                                                            position: "absolute"
                                                        }}></i> : <i onClick={() => setShowPassword(true)} className="fa fa-eye-slash " aria-hidden="true" id="togglePassword" style={{
                                                            top: "31%", marginLeft: "-30px",
                                                            cursor: "pointer",
                                                            position: "absolute"
                                                        }}></i>
                                    ...
                                    <form onSubmit={signUp}>
                                        <div className="user-details">
                                            ...
                                            <div style={{ position: "relative" }}>
                                                ...
                                                {/* <i className="fa fa-eye" aria-hidden="true" id="togglePassword1" style={{ top: "49%", marginLeft: "-30px", cursor: "pointer", position: "absolute" }}></i> */}
                                            </div>
                                            <div style={{ position: "relative" }}>
                                                ...
                                                {
                                                    showRepeatPassword ? <i onClick={() => setShowRepeatPassword(false)} className="fa fa-eye " aria-hidden="true" id="togglePassword" style={{
                                                        top: "45%", marginLeft: "-30px",
                                                        cursor: "pointer",
                                                        position: "absolute"
                                                    }}></i> : <i onClick={() => setShowRepeatPassword(true)} className="fa fa-eye-slash " aria-hidden="true" id="togglePassword" style={{
                                                        top: "45%", marginLeft: "-30px",
                                                        cursor: "pointer",
                                                        position: "absolute"
                                                    }}></i>
                    ...
                    <div className="sign_a">
                        {
                            !forgetModal && !signUpModal ? <button id="sign_click" onClick={() => setSignUpModal(true)}>Sign Up</button> : <button id="login_click_1a" style={{ display: 'block' }} onClick={handleLoginForm}>Login</button>
                        }
                    </div>
                </div>
            </div>
