                        ...
                        <div class="one_1 neumorphic1">
                            <div class="dropmenu">
                                <div class="sidenav">
                                    ...
                                    <a href="#contact"><i class="fa fa-credit-card" aria-hidden="true"></i> Payments</a>
                                    <a href="#contact"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a>
                                    <a href="#contact"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
                                </div>
                            </div>
                        </div>
                        <div class="one_2a">
                            <a href="open-order-listing.html"><button class="back_step"><i class="fa fa-angle-double-left"
                                aria-hidden="true"></i> Back </button></a>
                            <div class="clear"></div>
                            <h2>Private Limited Company - Basic Package</h2>
                            <p><b>Order Id - </b>216808</p>
                            <div class="box_pro">
                                <p>Hi, I am $Rajesh Sharma, handling your task.</p>
                                <div class="pro_in">
                                    <img src="img/boy.jpg" alt="" />
                                    <div class="about_i">
                                        <b>Reach Me</b><br />
                                        <span>rajesh@e-startupindia.com</span><br />
                                        <span>9999199991</span>
                                    </div>
                                </div>
                                <button class="chat_with_me" onclick="chat_with_me()"><i class="fa fa-commenting"
                                    aria-hidden="true"></i> Chat With Me</button><button class="call_me"><i
                                        class="fa fa-phone" aria-hidden="true"></i> Call Me</button>
                            </div>
                            <div class="steps_a">
                            ...
                            <div class="step_list">
                                ...
                                <p class="process_done">IEC Application successfully filed</p>
                            ...
                            <div class="payment_d">
                                ...
                                <button class="request_btn">Request GST Invoice</button>
                            </div>
