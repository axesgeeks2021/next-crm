                                                ...
                                                <form className="tab-1" style={{ display: !loginForm ? 'none' : 'block' }} onSubmit={signUp}>
                                                    ...
                                                    <div className="ui-form-01-wraper">
                                                        ...
                                                        <div className="input-icon " style={{ position: 'relative' }}>
                                                            ...
                                                            {/* {
                                showPassword ?
                                  <i className="fa fa-eye " aria-hidden="true" onClick={() => setShowPassword(false)}
                                    style={{ position: "absolute",top: "10px", cursor: 'pointer', background: "none", fontSize: "16px",  color: "#222" }}></i> : <i onClick={() => setShowPassword(true)} className="fa fa-eye-slash" aria-hidden="true"
                                      style={{ position: "absolute",top: "10px", cursor: 'pointer', background: "none", fontSize: "16px",  color: "#222" }}></i>
                              } */}
                                                            {/* <i className="icofont icofont-mobile-phone"></i> */}
                                                        </div>
                                                    ...
                                                    <div className="ui-form-01-wraper">
                                                        ...
                                                        <div style={{ position: "relative" }}>
                                                            ...
                                                            <div
                                                                ...
                                                                {/* {
                                !showPassword ? <i onClick={() => setShowPassword(true)} className="fa fa-eye pointer" aria-hidden="true" id="togglePassword" style={{
                                  top: "31%", marginLeft: "-30px",
                                  cursor: "pointer",
                                  position: "absolute"
                                }}></i> : <i onClick={() => setShowPassword(false)} className="fa fa-eye-slash pointer" aria-hidden="true" id="togglePassword" style={{
                                  top: "31%", marginLeft: "-30px",
                                  cursor: "pointer",
                                  position: "absolute"
                                }}></i>
                              } */}
                                                                {
                                                                    showPassword ?
                                                                        <i className="fa fa-eye " aria-hidden="true" onClick={() => setShowPassword(false)}
                                                                            style={{ position: "relative", cursor: 'pointer', background: "none", fontSize: "16px", marginTop: "9px", marginRight: "4px", color: "#222" }}></i> : <i onClick={() => setShowPassword(true)} className="fa fa-eye-slash" aria-hidden="true"
                                                                                style={{ position: "relative", cursor: 'pointer', background: "none", fontSize: "16px", marginTop: "9px", marginRight: "4px", color: "#222" }}></i>
                                                                }
                                                            </div>
                                                        </div>
                                                        <p className="package-processing"></p>
