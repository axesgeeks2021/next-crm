            ...
            <div className="marquee">
                <div className="marquee__content">
                    <ul className="list-inline">
                        <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> Company Incorporation</li>
                        <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> Business Licenses</li>
                        <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> Protecting Brands & Logo</li>
                        <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> Accounting & Compliances</li>
                        <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> VCFO</li>
                        <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> Import Export</li>
                    </ul>
                    <ul className="list-inline">
                    <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> Company Incorporation</li>
                        <li><FontAwesomeIcon icon={faArrowRight} color='#fff'/> Business Licenses</li>
