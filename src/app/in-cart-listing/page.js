                ...
                <div class="container_1">
                    <div class="after_login">
                        ...
                        <div class="one_2">
                            ...
                            <h2>In Cart Orders <i class="fa fa-shopping-cart" aria-hidden="true" style={{ color: "#ffc83d" }}></i>
                            </h2>
                            <div class="tabset">
                                ...
                                <div class="tab-panels">
                                    <section id="marzen" class="tab-panel">
                                        <div class="company_pro">
                                            ...
                                            <button class="view_Detail"><a href="in-cart-detail.html" target="_blank">View
                                                Detail</a></button>
